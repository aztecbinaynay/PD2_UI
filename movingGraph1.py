...
canvas1 = tk.Canvas(root, width=240, height=100)
canvas2 = tk.Canvas(root, width=240, height=100)
canvas3 = tk.Canvas(root, width=240, height=100)
canvas4 = tk.Canvas(root, width=240, height=100)
